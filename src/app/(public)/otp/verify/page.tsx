    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center bg-[#F2F1F6] rounded-[30px]">
            <div className="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
                <Typography as="h2" type="h2" className="text-2xl font-semibold text-center text-gray-800">
                    Verification
                </Typography>
                    ...
                    <div>
                                ...
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <input
                                            ...
                                            type="text"
                                            maxLength={1}
                                            className={`w-12 h-12 sm:w-14 sm:h-14 text-center border border-gray-300 rounded-[10px] text-lg font-semibold focus:outline-none ${errors.otp?.[index]
                        ...
                        {errors.otp && (
                            <p className="text-red-500 text-sm">
                                {errors.otp[0]?.message || errors.otp[1]?.message || errors.otp[2]?.message || errors.otp[3]?.message}
                            </p>
                        )}
                    </div>

                    <Typography as='p' type='p' className='text-sm mt-[10px]'>
                        Enter the confirmation code we just send you in your Email. Don&apos;t receive a code? <span className="font-bold cursor-pointer">resend</span>
                    </Typography>
