        ...
        <div className="min-h-screen flex flex-col justify-center items-center bg-[#F2F1F6] rounded-[30px]">
            <div className="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
                ...
                <form className='mt-6' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`mt-1 block w-full p-3 border rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${errors.email ? 'border-red-500' : 'border-gray-300'
                                }`}
                        />
                        {errors.email && (
                    ...
                    <div className="mb-4 relative">
                        ...
                        <div className="flex items-center relative">
                            <input
                                ...
                                className={`mt-1 block w-full p-3 border rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${errors.password ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            />
                            <button
                                type="button"
                ...
                <p className="text-sm text-center text-gray-600 mt-6">
                    ...
                    <span className="text-blue-600 hover:underline"> Terms</span>. Learn how we process your data in our
